...
struct StudentDynamic *createStudentDynamic(int id, char *name, int age, float gpa) {
...
int main() {
    ...
    struct StudentDynamic *studentDynamic = createStudentDynamic(1, "John loves me", 20, 3.5);
